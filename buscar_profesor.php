	...
	<section>
		...
		<form action="procesar_busqueda.php" method="post">
			...
			<select name="universidad">
				...
				<option value="Pontificie Universidad Catolica del Peru"> Pontificie Universidad Catolica del Peru </option>
			...
			<select name="curso">
				...
				<option value="Filosofia Social"> Filosofia Social </option>
